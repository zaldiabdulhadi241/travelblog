...
<body>
    ...
    <!-- Page Header-->
    <header class="masthead" style="background-image: url('assets/img/header-img.jpg'); background-position: bottom;">
        <div class="container position-relative px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    <div class="site-heading">
                        <h1>Travel Blog</h1>
                        <span class="subheading">A Travel Articles Where You Can Go</span>
                    </div>
                </div>
            </div>
        </div>
